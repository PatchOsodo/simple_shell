...
#define NODE_H
/**
 * enum node_type_e - defines the types of our AST nodes.
...
/**
 * enum val_type_e - represents the types of values we can store in a given node
 * @VAL_SINT: signed int
...
/**
 * union symval_u - represents the value we can store in a given node structure
 * @sint: signed int
 * @uint: unsigned int
 * @sllong: signed long
 * @ullong: unsigned long
 * @sfloat: signed float
 * @ldouble: long double
 * @chr: character
 * @str: string
